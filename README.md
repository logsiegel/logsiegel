...
Observability tools show what happened — Logsiegel makes it *provable*. It records
...
- **Logs in ordinary databases are silently editable.** When an AI decision is
  challenged, "our logs say X" proves nothing. Logsiegel makes any after-the-fact
...
logsiegel verify ./mylog          # PASS: hash chain + Merkle roots + signatures
